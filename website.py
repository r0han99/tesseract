...
if category == 'Neural Networks':
    ...
    if datatype == "Choose From pre-sampled data.":
        ...
        if submitted:
            ...
            col1.markdown(f'''The Model Classifies this Crime type to be: <b><span style="font-family:Georgia; font-size:18px; color:'red';">{classes[prediction.argmax()]}</span></b>''',unsafe_allow_html=True)
